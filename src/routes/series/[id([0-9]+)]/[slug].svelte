...
{#if $preloading}
    <div class="series-wrapper min-h-screen px-4 pt-8 max-w-5xl mx-auto mb-8">
        <div>
            <LoadingPulse class="h-64 w-48 bg-gray-200 dark:bg-gray-700 rounded mx-auto" />
            <LoadingPulse class="h-8 w-32 bg-gray-200 dark:bg-gray-700 rounded mt-4" />
            <LoadingPulse class="h-8 w-24 bg-gray-200 dark:bg-gray-700 rounded mt-4" />
        </div>
        <div>
            <LoadingPulse class="h-8 w-32 bg-gray-200 dark:bg-gray-700 rounded" />
            <LoadingPulse class="h-32 bg-gray-200 dark:bg-gray-700 rounded mt-4" />
            <LoadingPulse class="h-8 max-w-xl bg-gray-200 dark:bg-gray-700 rounded mt-4" />
            <LoadingPulse class="h-8 w-64 bg-gray-200 dark:bg-gray-700 rounded mt-8" />
            <LoadingPulse class="h-8 w-64 bg-gray-200 dark:bg-gray-700 rounded mt-4" />
            <LoadingPulse class="h-8 w-64 bg-gray-200 dark:bg-gray-700 rounded mt-4" />
            <LoadingPulse class="h-8 w-48 bg-gray-200 dark:bg-gray-700 rounded mt-8" />
            <LoadingPulse class="h-8 w-48 bg-gray-200 dark:bg-gray-700 rounded mt-4" />
            <LoadingPulse class="h-8 w-48 bg-gray-200 dark:bg-gray-700 rounded mt-4" />
        </div>
    </div>
{:else}
