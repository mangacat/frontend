<div class="relative" bind:this={container_elem}>
    ...
    {#if isOpen}
        <div transition:slide={{ duration: 250 }} bind:this={dropdown_elem} class="my-2 z-40 rounded py-3 px-2 w-full bg-white dark:bg-gray-700 shadow-lg">
            ...
            {:else}
                {$_.capital('no_results', { term: search })}
            {/if}
        </div>
    {/if}
</div>
